...
const ReportsPage = async ({
  ...
  const route = `${siteSections.writing.siteSections[WritingSections.reports].path}/${path}`
  return <Page title={siteSections.writing.siteSections[WritingSections.reports].title} path={route} />
}
